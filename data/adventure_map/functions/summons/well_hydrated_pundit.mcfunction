...
scoreboard players set @e[tag=unprocessed,sort=nearest,limit=1] fine_hp.hp 80
scoreboard players set @e[tag=unprocessed,sort=nearest,limit=1] fine_hp.mh 80
scoreboard players set @e[tag=unprocessed,sort=nearest,limit=1] fine_hp.prev_hp 80
