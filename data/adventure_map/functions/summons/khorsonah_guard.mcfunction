...
scoreboard players set @e[tag=unprocessed,sort=nearest,limit=1] fine_hp.tmp0 110
execute as @a run scoreboard players add @e[tag=unprocessed,sort=nearest,limit=1] fine_hp.tmp0 90
