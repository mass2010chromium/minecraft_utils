...
execute if entity @s[tag=charging] if entity @p[distance=0..4] run tag @s add charge_hit 
...
execute if entity @s[tag=charge_hit] run scoreboard players operation @a[distance=0..5] fine_hp.dmg += @s chargePD
execute if entity @s[tag=charge_hit] run scoreboard players operation @a[distance=0..5] fine_hp.mdmg += @s chargeMD 
