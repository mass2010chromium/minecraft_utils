...
# Different tiers
replaceitem entity @a[tag=ww_1,scores={mana.mana=400..}] container.2 minecraft:crossbow{ display:{ Name:'"Windwalk 1"', Lore:['"Archer: Active Spell"', '"Archer: Windwalk Spell"'] }, ChargedProjectiles:[{id:"minecraft:spectral_arrow",Count:1b}],Charged:1b,Enchantments:[{}] }
tag @a remove ww_1
