...
# Different tiers
replaceitem entity @a[tag=pa_1,scores={mana.mana=600..}] container.2 minecraft:crossbow{Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:4,ChargedProjectiles:[{id:"minecraft:spectral_arrow",Count:1b}],display:{ Name:'{"italic":false,"text":"Piercing Arrow 1"}', Lore:[ '{"italic":false,"color":"white","text":"Fire an arrow that pierces 7 enemies,"}','{"italic":false,"color":"white","text":"  dealing 10 magic damage and 7-10 physical damage."}','{"italic":false,"color":"blue","text":"Cost: 600MP"}', '{"text":"Archer: Active Spell"}', '{"text":"Archer: Piercing Arrow Spell"}', '{"text":"Archer: Slot 3"}' ] }, Charged:1b}
tag @a remove pa_1
...
# Different tiers
replaceitem entity @a[tag=ww_1,scores={mana.mana=400..}] container.2 minecraft:crossbow{Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:4,ChargedProjectiles:[{id:"minecraft:spectral_arrow",Count:1b}],display:{ Name:'{"italic":false,"text":"Windwalk 1"}', Lore:[ '{"italic":false,"color":"white","text":"Fire an arrow, dealing 5 magic damage"}','{"italic":false,"color":"white","text":"  and knocking opponents airborne."}','{"italic":false,"color":"white","text":"Grants speed II to caster for 5s."}','{"italic":false,"color":"white","text":"Grants speed I to caster and allies for 20s."}','{"italic":false,"color":"blue","text":"Cost: 400MP"}', '{"text":"Archer: Active Spell"}', '{"text":"Archer: Windwalk Spell"}', '{"text":"Archer: Slot 3"}' ] }, Charged:1b}
tag @a remove ww_1
...
execute as @e[tag=windwalk_arrow] at @s store success score @s fine_hp.tmp0 run scoreboard players operation @e[team=Enemies,distance=0..4,nbt={ActiveEffects:[{Id:24b}]}] fine_hp.mdmg += @s spell.6.power
