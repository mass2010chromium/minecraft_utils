...
replaceitem entity @s container.0 minecraft:iron_axe{Unbreakable:1,Enchantments:[{id:knockback,lvl:3}],display:{Name:'{"text":"Basic Axe","italic":false}',Lore:['"Archer: Melee"','"Archer: Slot 1"']}} 1
replaceitem entity @s container.1 minecraft:bow{Unbreakable:1, Enchantments:[ {id:infinity,lvl:1}, {id:power,lvl:3} ], display:{Name:'{"text":"Basic Bow","italic":false}', Lore:[ '"Archer: Bow"', '"Archer: Normal Arrows"', '"Archer: Slot 2"' ] }} 1
