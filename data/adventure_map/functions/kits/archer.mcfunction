...
replaceitem entity @s armor.feet minecraft:chainmail_boots{Unbreakable:1,Enchantments:[{id:"minecraft:binding_curse",lvl:1},{projectile_protection,lvl:1}],display:{Name:'"Archer\'s Boots"'}} 1
