...
replaceitem entity @s container.1 minecraft:bow{Unbreakable:1,Enchantments:[{id:infinity,lvl:1},{id:power,lvl:3}],display:{Name:'"Basic Bow"',Lore:['"Archer: Bow"']}} 1
replaceitem entity @s container.2 minecraft:crossbow{Enchantments:[{}],display:{Name:'"Windwalk 1"',Lore:['"Archer: Active Spell"', '"Archer: Windwalk Spell"']}} 1
