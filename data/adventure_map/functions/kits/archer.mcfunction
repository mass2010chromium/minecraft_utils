...
replaceitem entity @s container.1 minecraft:bow{Unbreakable:1,Enchantments:[{id:infinity,lvl:1},{id:power,lvl:3}],display:{Name:'{"text":"Basic Bow","italic":false}',Lore:['"Archer: Bow"','"Archer: Slot 2"']}} 1
