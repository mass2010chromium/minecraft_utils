...
# Class restriction
effect give @a[tag=!knight,nbt={SelectedItem:{tag:{display:{Lore:['{"text":"Knight: Sword"}']}}}}] slowness 3 9
effect give @a[tag=!knight,nbt={SelectedItem:{tag:{display:{Lore:['{"text":"Knight: Sword"}']}}}}] weakness 3 9
tag @a[tag=knight,nbt={SelectedItem:{tag:{display:{Lore:['{"text":"Knight: Sword"}']}}}}] add holdingWeapon
...
# Replenish items
tag @e[type=minecraft:item,nbt={Item:{tag:{display:{Lore:['{"text":"Knight: Sword"}']}}}},tag=!processed] add replenish_0
tag @e[type=minecraft:item,nbt={Item:{tag:{display:{Lore:['{"text":"Knight: Spear"}']}}}},tag=!processed] add replenish_1
tag @e[type=minecraft:item,nbt={Item:{tag:{display:{Lore:['{"text":"Knight: Active Spell"}']}}}},tag=!processed] add replenish_2 
tag @e[type=minecraft:trident,nbt={Trident:{tag:{display:{Lore:['{"text":"Knight: Spear"}']}}}},tag=!processed] add replenish_3  
...
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Basic Sword"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=knight] container.0 minecraft:stone_sword{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:5},{id:"minecraft:sweeping",lvl:1} ], display:{ Name:'{"italic":false,"text":"Basic Sword"}', Lore:[ '{"text":"Knight: Sword"}', '{"text":"Knight: Slot 1"}' ] }} 1
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Cast-Iron Sword"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=knight] container.0 minecraft:iron_sword{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:5},{id:"minecraft:sweeping",lvl:1} ], display:{ Name:'{"italic":false,"text":"Cast-Iron Sword"}', Lore:[ '{"text":"Knight: Sword"}', '{"text":"Knight: Slot 1"}' ] }} 1
execute as @e[tag=replenish_0,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Sandesite Sword"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:0},tag=!replenish_fail,tag=knight] container.0 minecraft:golden_sword{Unbreakable:1,HideFlags:4, Enchantments:[ {id:"minecraft:sharpness",lvl:10},{id:"minecraft:sweeping",lvl:2} ], display:{ Name:'{"italic":false,"text":"Sandesite Sword"}', Lore:[ '{"text":"Knight: Sword"}', '{"text":"Knight: Slot 1"}' ] }} 1  
# Trident drop protection
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Depths\' Curse 1"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Depths\' Curse 1"}', Lore:[ '{"italic":false,"color":"white","text":"Spear deals physical damage to whatever it hits."}','{"italic":false,"color":"white","text":"Deals 6 magic damage to enemies within 4 blocks"}','{"italic":false,"color":"white","text":"  and applies 10 seconds of slowness."}','{"italic":false,"color":"blue","text":"Cost: 400MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Depths\' Curse"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Mob Hook 1"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Mob Hook 1"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a hook that pulls mobs towards you,"}','{"italic":false,"color":"white","text":"  and deals physical damage."}','{"italic":false,"color":"blue","text":"Cost: 350MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Mob Hook Spell"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1   
# Ground Pound spell
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Ground Pound 1"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=knight] container.1 minecraft:anvil{Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Ground Pound 1"}', Lore:[ '{"italic":false,"color":"white","text":"Leap in the air and slam back down,"}','{"italic":false,"color":"white","text":"  launching nearby enemies airborne and"}','{"italic":false,"color":"white","text":"  dealing 20 physical damage."}','{"italic":false,"color":"white","text":"Grants temporary invulnerability while leaping."}','{"italic":false,"color":"blue","text":"Cost: 600MP"}', '{"text":"Knight: Active Spell"}', '{"text":"Knight: Ground Pound Spell"}', '{"text":"Knight: Slot 2"}' ] }} 1
# Set up spell success temp var
scoreboard players set @a[tag=knight] fine_hp.tmp0 0
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Lore:['{"text":"Knight: Ground Pound Spell"}']}}}},scores={replenish_ok=1}] run execute at @s run execute at @p[tag=knight,nbt={SelectedItemSlot:1},tag=!replenish_fail,distance=0..4,scores={mana.mana=600..}] store success score @p[tag=knight,nbt={SelectedItemSlot:1},tag=!replenish_fail,distance=0..4,scores={mana.mana=600..}] fine_hp.tmp0 run tag @s add cast_pound
...
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"italic":false,"text":"Shield 1"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=knight] container.1 minecraft:iron_door{Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Shield 1"}', Lore:[ '{"italic":false,"color":"white","text":"Grants a shield that blocks 4 melee hits, lasting 20s."}','{"italic":false,"color":"white","text":"Slows nearby enemies when the shield is used."}','{"italic":false,"color":"white","text":"Can\'t block ranged projectiles or area attacks."}','{"italic":false,"color":"blue","text":"Cost: 300MP"}', '{"text":"Knight: Active Spell"}', '{"text":"Knight: Shield Spell"}', '{"text":"Knight: Slot 2"}' ] }} 1
# Set up spell success temp var
scoreboard players set @a[tag=knight] fine_hp.tmp0 0
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Lore:['{"text":"Knight: Shield Spell"}']}}}},scores={replenish_ok=1}] run execute at @s run tag @p[tag=knight,nbt={SelectedItemSlot:1},tag=!replenish_fail,distance=0..4,scores={mana.mana=300..}] add cast_shield
# Remove mana if successful
...
# Depth's Curse
execute as @e[tag=replenish_3,nbt={Trident:{tag:{display:{Name:'{"italic":false,"text":"Depths\' Curse 1"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Depths\' Curse 1"}', Lore:[ '{"italic":false,"color":"white","text":"Spear deals physical damage to whatever it hits."}','{"italic":false,"color":"white","text":"Deals 6 magic damage to enemies within 4 blocks"}','{"italic":false,"color":"white","text":"  and applies 10 seconds of slowness."}','{"italic":false,"color":"blue","text":"Cost: 400MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Depths\' Curse"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1 
scoreboard players set @a[tag=knight] fine_hp.tmp0 0
execute as @e[tag=replenish_3,nbt={Trident:{tag:{display:{Lore:['{"text":"Knight: Depths\' Curse"}']}}}},scores={replenish_ok=1}] run execute at @s run execute at @p[tag=knight,nbt={SelectedItemSlot:2},tag=!replenish_fail,distance=0..4,scores={mana.mana=400..}] store success score @p[tag=knight,nbt={SelectedItemSlot:2},tag=!replenish_fail,distance=0..4,scores={mana.mana=400..}] fine_hp.tmp0 run tag @s add depths_curse 
...
execute as @e[tag=replenish_3,scores={replenish_ok=0},tag=!depths_curse,nbt={Trident:{tag:{display:{Name:'{"italic":false,"text":"Depths\' Curse 1"}'}}}}] at @s run summon item ~ ~ ~ {Item:{id:trident,Count:1b,tag:{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Depths\' Curse 1"}', Lore:[ '{"italic":false,"color":"white","text":"Spear deals physical damage to whatever it hits."}','{"italic":false,"color":"white","text":"Deals 6 magic damage to enemies within 4 blocks"}','{"italic":false,"color":"white","text":"  and applies 10 seconds of slowness."}','{"italic":false,"color":"blue","text":"Cost: 400MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Depths\' Curse"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]}}} 
...
# Mob Hook
execute as @e[tag=replenish_3,nbt={Trident:{tag:{display:{Name:'{"italic":false,"text":"Mob Hook 1"}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=knight] container.2 minecraft:trident{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Mob Hook 1"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a hook that pulls mobs towards you,"}','{"italic":false,"color":"white","text":"  and deals physical damage."}','{"italic":false,"color":"blue","text":"Cost: 350MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Mob Hook Spell"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]} 1 
scoreboard players set @a[tag=knight] fine_hp.tmp0 0
execute as @e[tag=replenish_3,nbt={Trident:{tag:{display:{Lore:['{"text":"Knight: Mob Hook Spell"}']}}}},scores={replenish_ok=1}] run execute at @s run execute at @p[tag=knight,nbt={SelectedItemSlot:2},tag=!replenish_fail,distance=0..4,scores={mana.mana=350..}] store success score @p[tag=knight,nbt={SelectedItemSlot:2},tag=!replenish_fail,distance=0..4,scores={mana.mana=350..}] fine_hp.tmp0 run tag @s add mob_hook 
...
execute as @e[tag=replenish_3,scores={replenish_ok=0},tag=!mob_hook,nbt={Trident:{tag:{display:{Name:'{"italic":false,"text":"Mob Hook 1"}'}}}}] at @s run summon item ~ ~ ~ {Item:{id:trident,Count:1b,tag:{Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:5, display:{ Name:'{"italic":false,"text":"Mob Hook 1"}', Lore:[ '{"italic":false,"color":"white","text":"Shoot a hook that pulls mobs towards you,"}','{"italic":false,"color":"white","text":"  and deals physical damage."}','{"italic":false,"color":"blue","text":"Cost: 350MP"}', '{"text":"Knight: Spear"}', '{"text":"Knight: Mob Hook Spell"}', '{"text":"Knight: Slot 3"}' ] },AttributeModifiers:[]}}} 
...
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:0b,tag:{display:{Lore:['{"text":"+1 Ground Pound Power"}']}}}]}] spell.10.power 15
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:1b,tag:{display:{Lore:['{"text":"+1 Ground Pound Power"}']}}}]}] spell.10.power 15
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:2b,tag:{display:{Lore:['{"text":"+1 Ground Pound Power"}']}}}]}] spell.10.power 15 
scoreboard players set @a[tag=knight] spell.11.power 4
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:0b,tag:{display:{Lore:['{"text":"+2 Shield uses"}']}}}]}] spell.11.power 2
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:1b,tag:{display:{Lore:['{"text":"+2 Shield uses"}']}}}]}] spell.11.power 2
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:2b,tag:{display:{Lore:['{"text":"+2 Shield uses"}']}}}]}] spell.11.power 2 
scoreboard players set @a[tag=knight] spell.8.power 6
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:0b,tag:{display:{Lore:['{"text":"+6 Depths\' Curse Magic Damage"}']}}}]}] spell.8.power 6
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:1b,tag:{display:{Lore:['{"text":"+6 Depths\' Curse Magic Damage"}']}}}]}] spell.8.power 6
scoreboard players add @a[tag=knight,nbt={Inventory:[{Slot:2b,tag:{display:{Lore:['{"text":"+6 Depths\' Curse Magic Damage"}']}}}]}] spell.8.power 6