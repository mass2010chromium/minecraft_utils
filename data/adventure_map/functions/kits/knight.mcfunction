...
replaceitem entity @s container.0 minecraft:stone_sword{Unbreakable:1,Enchantments:[{id:"minecraft:sharpness",lvl:3}],display:{Name:'"Basic Sword"',Lore:['"Knight: Sword"']}} 1
