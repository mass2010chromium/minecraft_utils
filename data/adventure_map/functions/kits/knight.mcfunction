...
replaceitem entity @s container.2 minecraft:trident{Unbreakable:1b, Enchantments:[{}], display:{ Name:'{"text":"Depths\' Curse 1","italic":false}', Lore:[ '{"text":"Launch a spear, dealing physical damage to whatever it hits.","color":"white","italic":false}','{"text":"Additionally, deals 6 magic damage to enemies within 4 blocks,  and applies 10 seconds of slowness.","color":"white","italic":false}','{"text":"Cost: 400MP","color":"blue","italic":false}', '"Knight: Spear"', '"Knight: Depths\' Curse"' ] },AttributeModifiers:[]} 1
