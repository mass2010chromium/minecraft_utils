...
replaceitem entity @s container.1 minecraft:trident{Unbreakable:1b,Enchantments:[{id:"minecraft:knockback",lvl:2}],display:{Name:'"Spear 1"',Lore:['{"text":"Knight: Spear","italic":false}']},AttributeModifiers:[]} 1
