...
# Class restriction
effect give @a[tag=!mage,nbt={SelectedItem:{tag:{display:{Lore:['"Mage: Staff"']}}}}] slowness 3 9
effect give @a[tag=!mage,nbt={SelectedItem:{tag:{display:{Lore:['"Mage: Staff"']}}}}] weakness 3 9
tag @a[tag=mage,nbt={SelectedItem:{tag:{display:{Lore:['"Mage: Staff"']}}}}] add holdingWeapon
...
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"text":"Cyclone Spear 1","italic":false}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=mage] container.1 minecraft:feather{Enchantments:[{}], display:{ Name:'{"text":"Cyclone Spear 1","italic":false}', Lore:[ '{"text":"Shoot a straight projectile, dealing 25 damage.","color":"white","italic":false}','{"text":"Can be stopped by thick crowds.","color":"white","italic":false}','{"text":"Cost: 500MP","color":"blue","italic":false}', '"Mage: Primary Spell"', '"Mage: Cyclone Spear Spell"', '"Mage: Slot 2"' ] }} 1 
