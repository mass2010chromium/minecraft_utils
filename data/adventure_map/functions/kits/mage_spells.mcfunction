...
# Fireball spell
execute as @e[tag=replenish_1,nbt={Item:{tag:{display:{Name:'{"text":"Fireball 1","italic":false}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:1},tag=!replenish_fail,tag=mage] container.1 minecraft:blaze_rod{Enchantments:[{}], display:{ Name:'{"text":"Fireball 1","italic":false}', Lore:[ '{"text":"Shoot a fireball that explodes on contact or after 0.5s,","color":"white","italic":false}','{"text":"  dealing 3 physical damage and 10 magic damage.","color":"white","italic":false}','{"text":"Damage decreases with distance from explosion center.","color":"white","italic":false}','{"text":"A direct hit does even more damage.","color":"white","italic":false}','{"text":"Can hurt self and allies!","color":"white","italic":false}','{"text":"Cost: 200MP","color":"white","italic":false}', '"Mage: Primary Spell"', '"Mage: Fireball Spell"' ] }} 1
...
# Zephyr spell
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"text":"Zephyr 1","italic":false}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=mage] container.2 minecraft:magma_cream{Enchantments:[{}],display:{Name:'{"text":"Zephyr 1","italic":false}',Lore:['{"text":"Grant Speed II and Strength I to caster for 5 seconds.","color":"white","italic":false}','{"text":"Grand Speed I to caster and allies for 80 seconds.","color":"white","italic":false}','{"text":"Cost: 400MP","color":"white","italic":false}', '"Mage: Secondary Spell"', '"Mage: Zephyr Spell"']}} 1 
scoreboard players set @a[tag=mage] fine_hp.tmp0 0
...
execute as @e[tag=replenish_2,nbt={Item:{tag:{display:{Name:'{"text":"Arcane Explosion 1","italic":false}'}}}}] at @s store success score @s replenish_ok run replaceitem entity @p[distance=0..4,nbt={SelectedItemSlot:2},tag=!replenish_fail,tag=mage] container.2 minecraft:nether_star{Enchantments:[{}],display:{Name:'{"text":"Arcane Explosion 1","italic":false}',Lore:['{"text":"Push enemies away.","color":"white","italic":false}','{"text":"Cost: 400MP","color":"white","italic":false}', '"Mage: Secondary Spell"', '"Mage: Arcane Explosion Spell"']}} 1 
scoreboard players set @a[tag=mage] fine_hp.tmp0 0
