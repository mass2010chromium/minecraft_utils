...
execute at @s[tag=spell.10.tag] run playsound minecraft:entity.player.burp block @a ~ ~-2 ~
...
tag @s[type=minecraft:item,nbt={Item:{tag:{display:{Name:'{"text":"Healing Potion 2","italic":false}'}}}}] add spell.13.tag
...
execute at @s[tag=spell.12.tag] run scoreboard players add @p fine_hp.potreg 15
execute as @s[tag=spell.12.tag] run particle heart ~ ~ ~ 0.25 0.25 0.25 0 5 force
tag @s remove spell.12.tag 
tag @s[type=minecraft:item,nbt={Item:{tag:{display:{Name:'{"text":"Healing Potion 3","italic":false}'}}}}] add spell.15.tag
...
execute at @s[tag=spell.14.tag] run scoreboard players add @p fine_hp.potreg 20
