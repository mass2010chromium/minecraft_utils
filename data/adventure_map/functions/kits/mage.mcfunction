...
replaceitem entity @s container.1 minecraft:blaze_rod{Enchantments:[{}],display:{Name:'"Fireball 1"',Lore:['"Mage: Primary Spell"', '"Mage: Fireball Spell"']}} 1
replaceitem entity @s container.2 minecraft:magma_cream{Enchantments:[{}],display:{Name:'"Lightning 1"',Lore:['"Mage: Secondary Spell"']}} 1 
# Testing
replaceitem entity @s container.6 minecraft:golden_hoe{Unbreakable:1,Enchantments:[{id:"minecraft:sharpness",lvl:1}],display:{Name:'"Fiery Staff"',Lore:['"Mage: Staff"', '"+1 Fireball Power"']}} 1
replaceitem entity @s container.7 minecraft:blaze_rod{Enchantments:[{}],display:{Name:'"Fireball 2"',Lore:['"Mage: Primary Spell"', '"Mage: Fireball Spell"', '"+1 Fireball Power"']}} 1  
