...
replaceitem entity @s container.0 minecraft:golden_hoe{Unbreakable:1,Enchantments:[{id:"minecraft:sharpness",lvl:3}],display:{Name:'"Basic Staff"',Lore:['"Mage: Staff"']}} 1
...
replaceitem entity @s container.2 minecraft:nether_star{Enchantments:[{}],display:{Name:'"Arcane Explosion 1"',Lore:['"Mage: Secondary Spell"', '"Mage: Arcane Explosion Spell"']}} 1
